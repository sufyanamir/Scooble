...
if(isset($user->role) && $user->role == user_roles('1')){
    $notifications  = Notification::where('status','nseen')->orderBy('id', 'desc')->get()->toArray();
...
<body style="background-color: #F5F5F5;">
  ...
  <div class="sidebar">
    <!-- <div class="mb-2 d-none" id=   "logo-img">
    ...
    <ul class="nav-list pl-0 sidebar_list">
      ...
      <li>
        <a href="{{'/client'}}">
          ...
          <span class="link_name">@lang('lang.clients')</span>
        </a>
        <!-- <span class="tooltip">@lang('lang.clients')</span> -->
      </li>
      @endif
      ...
      <li>
        <a href="{{ '/drivers'}}">
          ...
          <span class="link_name">@lang('lang.drivers')</span>
        </a>
        <!-- <span class="tooltip">@lang('lang.drivers')</span> -->
      </li>
      @endif
        ...
        <a href="{{'/routes'}}">
          <i class="mt-3 ml-3">
            <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4.79855 8.88835C6.49428 8.88835 7.86895 7.51369 7.86895 5.81796C7.86895 4.12222 6.49428 2.74756 4.79855 2.74756C3.10281 2.74756 1.72815 4.12222 1.72815 5.81796C1.72815 7.51369 3.10281 8.88835 4.79855 8.88835Z" stroke="white" stroke-width="1.5" />
              <path d="M14.8871 14.1514H17.5189C18.4838 14.1514 19.2734 14.9409 19.2734 15.9059V18.5376C19.2734 19.5026 18.4838 20.2922 17.5189 20.2922H14.8871C13.9221 20.2922 13.1326 19.5026 13.1326 18.5376V15.9059C13.1326 14.9409 13.9221 14.1514 14.8871 14.1514Z" stroke="white" stroke-width="1.5" />
              <path d="M10.527 5.37891H12.8781C14.501 5.37891 15.2554 7.38782 14.036 8.45808L7.02676 14.5901C5.80738 15.6516 6.56182 17.6605 8.17597 17.6605H10.527" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M4.8128 5.81753H4.82294" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M16.2172 17.2222H16.2277" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </i>
          <span class="link_name">@lang('lang.routes')</span>
        </a>
        ...
        <a href="{{'calender'}}">
          <i class="mt-3 ml-3">
            <svg width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M12.3595 1.58152L12.3604 2.26867C14.7707 2.46658 16.3629 4.18721 16.3655 6.82589L16.375 14.5495C16.3784 17.4264 14.6532 19.1965 11.8878 19.2011L5.1329 19.2103C2.38479 19.2139 0.637964 17.4017 0.634509 14.5165L0.625006 6.88361C0.62155 4.22753 2.15759 2.51147 4.5679 2.27967L4.56704 1.59251C4.56617 1.18938 4.85126 0.886117 5.23138 0.886117C5.61151 0.885201 5.8966 1.18755 5.89746 1.59068L5.89832 2.23203L11.03 2.2247L11.0291 1.58335C11.0282 1.18022 11.3133 0.877871 11.6934 0.876955C12.0649 0.876039 12.3587 1.17839 12.3595 1.58152ZM1.95629 7.16672L15.0359 7.1484V6.82772C14.9988 4.85788 14.0554 3.8244 12.3621 3.67047L12.363 4.37595C12.363 4.76992 12.0701 5.08235 11.6986 5.08235C11.3185 5.08326 11.0326 4.77175 11.0326 4.37778L11.0317 3.63566L5.90005 3.64299L5.90092 4.3842C5.90092 4.77908 5.61669 5.09059 5.23657 5.09059C4.85645 5.09151 4.57049 4.78092 4.57049 4.38603L4.56963 3.68055C2.885 3.85738 1.95284 4.89453 1.95543 6.88178L1.95629 7.16672ZM11.3349 11.3309V11.341C11.3436 11.7624 11.6718 12.0822 12.0701 12.073C12.4589 12.0629 12.769 11.7139 12.7604 11.2924C12.7422 10.8893 12.4304 10.5604 12.0425 10.5613C11.6451 10.5704 11.3341 10.9094 11.3349 11.3309ZM12.0485 15.4447C11.6511 15.4355 11.3306 15.0883 11.3297 14.6668C11.3211 14.2453 11.6399 13.8963 12.0373 13.8862H12.0459C12.452 13.8862 12.7811 14.2334 12.7811 14.6641C12.782 15.0947 12.4537 15.4437 12.0485 15.4447ZM7.7756 11.3455C7.79288 11.767 8.12203 12.0959 8.51943 12.0776C8.90819 12.0584 9.21834 11.7102 9.20106 11.2887C9.19156 10.8764 8.87191 10.5558 8.48315 10.5567C8.08575 10.575 7.77474 10.9241 7.7756 11.3455ZM8.52289 15.4034C8.12549 15.4218 7.7972 15.0928 7.77906 14.6714C7.77906 14.2499 8.0892 13.9018 8.4866 13.8825C8.87536 13.8816 9.19588 14.2023 9.20451 14.6137C9.22266 15.036 8.91165 15.3842 8.52289 15.4034ZM4.21629 11.3776C4.23357 11.7991 4.56272 12.1289 4.96011 12.1097C5.34888 12.0913 5.65902 11.7423 5.64088 11.3208C5.63224 10.9085 5.31259 10.5878 4.92297 10.5888C4.52557 10.6071 4.21542 10.9562 4.21629 11.3776ZM4.96357 15.408C4.56617 15.4273 4.23788 15.0974 4.21974 14.676C4.21888 14.2545 4.52989 13.9054 4.92729 13.8871C5.31605 13.8862 5.63656 14.2069 5.6452 14.6192C5.66334 15.0406 5.35319 15.3897 4.96357 15.408Z" fill="white" />
            </svg>
          </i>
          <span class="link_name">@lang('lang.calendar')</span>
        </a>
        <!-- <span class="tooltip">@lang('lang.calendar')</span> -->
      </li>
      @endif
      ...
      <li>
        ...
        <!-- <span class="tooltip">@lang('lang.users')</span> -->
      </li>
      @endif
      ...
      <li>
        <a href="{{'/announcements'}}">
          ...
          <span class="link_name">@lang('lang.announcements')</span>
        </a>
        <!-- <span class="tooltip">@lang('lang.announcements')</span> -->
      </li>
      @endif
      ...
      <li>
        <a href="{{'/notifications'}}">
          ...
          <span class="link_name">@lang('lang.notifications')</span>
        </a>
        <!-- <span class="tooltip">@lang('lang.notifications')</span> -->
      </li>
      @endif
      ...
      <li>
        <a href="/announcements_alerts">
          <i class="mt-3 ml-3">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M20.4023 13.5801C20.76 13.7701 21.036 14.0701 21.2301 14.3701C21.6083 14.9901 21.5776 15.7501 21.2097 16.4201L20.4943 17.6201C20.1162 18.2601 19.411 18.6601 18.6855 18.6601C18.3278 18.6601 17.9292 18.5601 17.6022 18.3601C17.3365 18.1901 17.0299 18.1301 16.7029 18.1301C15.6911 18.1301 14.8429 18.9601 14.8122 19.9501C14.8122 21.1001 13.872 22.0001 12.6968 22.0001H11.3069C10.1215 22.0001 9.18125 21.1001 9.18125 19.9501C9.16081 18.9601 8.31259 18.1301 7.30085 18.1301C6.96361 18.1301 6.65702 18.1901 6.40153 18.3601C6.0745 18.5601 5.66572 18.6601 5.31825 18.6601C4.58245 18.6601 3.87729 18.2601 3.49917 17.6201L2.79402 16.4201C2.4159 15.7701 2.39546 14.9901 2.77358 14.3701C2.93709 14.0701 3.24368 13.7701 3.59115 13.5801C3.87729 13.4401 4.06125 13.2101 4.23498 12.9401C4.74596 12.0801 4.43937 10.9501 3.57071 10.4401C2.55897 9.87012 2.23194 8.60012 2.81446 7.61012L3.49917 6.43012C4.09191 5.44012 5.35913 5.09012 6.38109 5.67012C7.27019 6.15012 8.425 5.83012 8.9462 4.98012C9.10972 4.70012 9.20169 4.40012 9.18125 4.10012C9.16081 3.71012 9.27323 3.34012 9.4674 3.04012C9.84553 2.42012 10.5302 2.02012 11.2763 2.00012H12.7172C13.4735 2.00012 14.1582 2.42012 14.5363 3.04012C14.7203 3.34012 14.8429 3.71012 14.8122 4.10012C14.7918 4.40012 14.8838 4.70012 15.0473 4.98012C15.5685 5.83012 16.7233 6.15012 17.6226 5.67012C18.6344 5.09012 19.9118 5.44012 20.4943 6.43012L21.179 7.61012C21.7718 8.60012 21.4447 9.87012 20.4228 10.4401C19.5541 10.9501 19.2475 12.0801 19.7687 12.9401C19.9322 13.2101 20.1162 13.4401 20.4023 13.5801ZM9.10972 12.0101C9.10972 13.5801 10.4076 14.8301 12.0121 14.8301C13.6165 14.8301 14.8838 13.5801 14.8838 12.0101C14.8838 10.4401 13.6165 9.18012 12.0121 9.18012C10.4076 9.18012 9.10972 10.4401 9.10972 12.0101Z" fill="white" />
            </svg>
          </i>
          <span class="link_name">@lang('lang.announcements_alerts')</span>
        </a>
        <!-- <span class="tooltip">@lang('lang.announcements_alerts')</span> -->
      </li>
      @endif

      @if(view_permission('pdf_templates'))
      <!-- <li>
        <a href="/pdf_templates">
          <i class="ml-3 fa fa-file-pdf">
          </i>
      ...
      <li>
        <a href="{{'/packages'}}">
          ...
          <span class="link_name">@lang('lang.packages')</span>
        </a>
      ...
      <li>
        <a href="/home">
          <i class="ml-3 fa fa-home">
          </i>
          <span class="link_name">@lang('lang.home')</span>
        </a>
      </li>
      @endif -->
