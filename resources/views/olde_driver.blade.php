...
@section('main-section')
        ...
        <div class="container-fluid px-0">
            <div class="bg-white p-3" style="border-radius: 20px;">
                    ...
                    @if ($data['status'] != $tripStatus['Completed'])
                        <div class="col-lg-9 mb-2 text-right" id ="btn-trip_manage">
                            @if ($data['status'] == $tripStatus['Pending'])
                                <button id="btn_start-trip" class="btn text-white  btn-info btn-md" data-toggle="modal"
                                    data-target="#starttripmodal"
                                    style=" background-color: #0F771A;"><span>@lang('lang.start_trip')</span></button>
                            @elseif($data['trip_date'] && $data['status'] == $tripStatus['In Progress'])
                                <button id="btn_started-trip" style="background-color: #0F771A; opacity: 0.5;" disabled
                                    class="btn text-white btn-md"><span>@lang('lang.trip_started')</span></button>
                            @endif
                            <button id="btn-end_trip" class="btn btn-md text-white"
                                style="background-color: #233A85;"><span>@lang('lang.end_trip')</span></button>
                        </div>
                    @else
                        <div class="col-lg-9 mb-2 text-right">
                            <button class="btn btn-md text-white"
                                style="background-color: #233A85;"><span>@lang('lang.trip_completed')</span></button>
                        </div>
                    @endif
                </div>
                <div class="row position-relative">
                    ...
                    <div class="position-relative">
                        <div style="">
                            <button id="wpshow_btn" class="w-point-btn fs-5"><i
                            ...
                            <div class="card" id="card_way_point" style="border-radius: 20px;">
                                ...
                                <div class="card-body px-2 py-0">
                                    ...
                                    <div class="text-right mt-1">
                                        ...
                                        <button id="btn-waypoint_details" data-address_id=""
                                            class="btn d-none p-0 btn-sm" data-toggle="modal"
                                            data-target="#picsignnotemodal">
                                            <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <circle opacity="0.1" cx="18" cy="18" r="18"
                                                    fill="#DF6F79" />
                                                <path
                                                    d="M22.7679 16.7143H18.9107V12.8571C18.9107 12.3838 18.5269 12 18.0536 12H17.1964C16.7231 12 16.3393 12.3838 16.3393 12.8571V16.7143H12.4821C12.0088 16.7143 11.625 17.0981 11.625 17.5714V18.4286C11.625 18.9019 12.0088 19.2857 12.4821 19.2857H16.3393V23.1429C16.3393 23.6162 16.7231 24 17.1964 24H18.0536C18.5269 24 18.9107 23.6162 18.9107 23.1429V19.2857H22.7679C23.2412 19.2857 23.625 18.9019 23.625 18.4286V17.5714C23.625 17.0981 23.2412 16.7143 22.7679 16.7143Z"
                                                    fill="#E45F00" />
                                            </svg>
                                        </button>
                                        <button id="btn-next_waypoint" data-address_id="" class="btn  d-none p-0 btn-sm">
                                            <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <circle opacity="0.1" cx="18" cy="18" r="18"
                                                    fill="#109CF1" fill-opacity="0.3" />
                                                <path
                                                    d="M18.4808 18.6373L13.3824 23.7357C13.03 24.0881 12.4602 24.0881 12.1115 23.7357L11.2643 22.8885C10.9119 22.5361 10.9119 21.9663 11.2643 21.6176L14.8782 18.0037L11.2643 14.3899C10.9119 14.0375 10.9119 13.4677 11.2643 13.119L12.1078 12.2643C12.4602 11.9119 13.03 11.9119 13.3786 12.2643L18.477 17.3627C18.8332 17.7151 18.8332 18.2849 18.4808 18.6373ZM25.6785 17.3627L20.5801 12.2643C20.2277 11.9119 19.6579 11.9119 19.3093 12.2643L18.462 13.1115C18.1097 13.4639 18.1097 14.0337 18.462 14.3824L22.0759 17.9963L18.462 21.6101C18.1097 21.9625 18.1097 22.5323 18.462 22.881L19.3093 23.7282C19.6617 24.0806 20.2315 24.0806 20.5801 23.7282L25.6785 18.6298C26.0309 18.2849 26.0309 17.7151 25.6785 17.3627Z"
                                                    fill="#109CF1" fill-opacity="0.3" />
                                            </svg>
                                        </button>
                                        <button id="btn-complete_waypoint" data-address_id=""
                                            class="btn d-none p-0 btn-sm">
                                            <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <circle opacity="0.1" cx="18" cy="18" r="18"
                                                    fill="#31A613" fill-opacity="0.3" />
                                                <path
                                                    d="M23.0507 12.2332C22.1581 11.7366 21.0338 12.0597 20.54 12.9504L17.1126 19.1183L15.1511 17.1568C14.4302 16.4359 13.2616 16.4359 12.5407 17.1568C11.8198 17.8777 11.8198 19.0463 12.5407 19.7672L16.2329 23.4595C16.5819 23.8093 17.0526 24.0013 17.5382 24.0013L17.7938 23.9829C18.3671 23.9026 18.8701 23.5583 19.1517 23.0515L23.767 14.7439C24.2627 13.8523 23.9414 12.7289 23.0507 12.2332Z"
                                                    fill="#31A613" fill-opacity="0.3" />
                                            </svg>
                                        </button>
                                    </div>
    ...
    <!-- Tripend  start-->
    <div class="modal fade" id="tripend" tabindex="-1" role="dialog" aria-labelledby="updatemodalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header pb-0" style="border-bottom: none;">
                    <button type="button" id="btn_endrtrip-close" class="close" data-dismiss="modal"
                ...
                <div class="modal-body px-5 pb-5 pt-0">
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-6 mb-2">
                            <button data-dismiss="modal" data-bs-dismiss="modal" class="btn btn-sm btn-outline px-5 py-2"
                                style="background-color: #ffffff; border: 1px solid #D0D5DD; border-radius: 8px; width: 100%;">@lang('lang.cancel')</button>
                        </div>
                        <div class="col-lg-6">
                            <form class="status_update" id="form_statusUpdate" action="updateTrip_status"
                                method="POST">
                                <input type="hidden" name="id" value="{{ $data['id'] ?? '' }}">
                                <input type="hidden" name="status" value="{{ $tripStatus['Completed'] ?? '' }}">
                                <button class="btn btn-sm btn_statusUpdate px-5 text-white py-2"
                                    style="background-color: #233A85; border-radius: 8px; width: 100%;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body px-5 pb-5 pt-0">
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-6 mb-2">
                            <button data-dismiss="modal" class="btn btn-sm btn-outline px-5 py-2"
                                style="background-color: #ffffff; border: 1px solid #D0D5DD; border-radius: 8px; width: 100%;">@lang('lang.cancel')</button>
                        </div>

                        <div class="col-lg-6">
                            <button id="btn_addressUpdate" class="btn btn-sm btn_addressUpdate px-5 text-white py-2"
                                style="background-color: #233A85; border-radius: 8px; width: 100%;">
                                <div class="spinner-border spinner-border-sm text-white d-none" id="spinner"></div>
                                <span id="text">@lang('lang.yes'), @lang('lang.confirm')</span>
                            </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 pb-5 pt-0">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-6">
                            <button id="btn_optimize_addresses" class="btn btn-sm px-5 text-white py-2"
                                style="background-color: #233A85; border-radius: 8px; width: 100%;">@lang('lang.yes'),
    ...
    <div class="modal fade" id="starttripmodal" tabindex="-1" role="dialog" aria-labelledby="starttripmodalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header pb-0" style="border-bottom: none;">
                    ...
                    @if ($remainingDays > 0)
                        <h4 style="font-size: larger;">@lang('lang.you_cannot_start_the_trip_now').</h5>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6">
                                    <button data-dismiss="modal" class="btn btn-sm px-5 text-white py-2"
                                        style="background-color: #233A85; border-radius: 8px; width: 100%;">@lang('lang.ok')</button>
                                </div>
                            </div>
                        @elseif ($remainingDays < 0)
                            <h4 style="font-size: larger;">@lang('lang.trip_delayed'): @lang('lang.start_date_passed')</h5>
                                <p>@lang('lang.sorry'), @lang('lang.you_cant_start_the_trip_now'). @lang('lang.youre') {{ abs($remainingDays) }}
                                    {{ $remainingDays == -1 ? 'day' : 'days' }} @lang('lang.late'). @lang('lang.please_contact_your_owner').</p>
                                <div class="row mt-3">
                                    <div class="col-lg-6">
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            @else
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6 mb-2">
                                        <button id="btn_status-close" data-dismiss="modal"
                                            class="btn btn-sm btn-outline px-5 py-2"
                                            style="background-color: #ffffff; border: 1px solid #D0D5DD; border-radius: 8px; width: 100%;">@lang('lang.cancel')</button>
                                    </div>
                                    <div class="col-lg-6">
                                        <form class="status_update" id="form_statusUpdate" action="updateTrip_status"
    ...
    <div class="modal fade" id="skipwaypointmodal" tabindex="-1" role="dialog"
        aria-labelledby="skipwaypointmodalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header pb-0" style="border-bottom: none;">
                ...
                <div class="modal-body px-5 pb-5 pt-0">
                    ...
                    <form class="status_update" id="skip_address" action="updateTrip_status" method="POST">
                        <input type="hidden" name="status" id="address_status"
                            value="{{ $addressStatus['Skipped'] ?? '' }}">
                        <input type="hidden" name="id" value="{{ $data['id'] ?? '' }}">
                        <input type="hidden" name="address_id" id="address_id">
                        <textarea name="skiped_address_desc" id="skiped_address_desc" cols="" rows=""
                            placeholder="Write reason here..." class="form-control"></textarea>
                        <p id="charCountContainer" class="text-secondary text-right" style="display: none;"><span
                                id="charCount">150</span> /150</p>
                        <div id="error_message" style="display: none; color: red;"></div>
                        <div class="row mt-3">
                            <div class="col-lg-6 mb-2">
                                <button type="reset" id="btn_modal-close" data-bs-dismiss="modal"
                                    class="btn btn-sm btn-outline px-5 py-2"
                                    style="background-color: #ffffff; border: 1px solid #D0D5DD; border-radius: 8px; width: 100%;">@lang('lang.cancel')</button>
                            </div>
                            <div class="col-lg-6">
                                <button class="btn btn-sm px-5 btn_statusUpdate text-white py-2" id="btn_save"
                                    style="background-color: #233A85; border-radius: 8px; width: 100%;">
                                    <div class="spinner-border spinner-border-sm text-white d-none" id="spinner"></div>
                                    <span id="text">@lang('lang.yes'), @lang('lang.confirm')</span>
                                </button>
    ...
    <div class="modal fade" id="completepointmodal" tabindex="-1" role="dialog"
        aria-labelledby="skipwaypointmodalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header pb-0" style="border-bottom: none;">
                ...
                <div class="modal-body px-5 pb-5 pt-0">
                    ...
                    <form class="status_update" id="complete_address" action="updateTrip_status" method="POST">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6">
                                <button class="btn btn-sm px-5 btn_statusUpdate text-white py-2"
                                    style="background-color: #233A85; border-radius: 8px; width: 100%;">
                                    <div class="spinner-border spinner-border-sm text-white d-none" id="spinner"></div>
                                    <span id="text">@lang('lang.yes'), @lang('lang.confirm')</span>
                                </button>
    ...
    <div class="modal fade " id="nextpointmodal" tabindex="-1" role="dialog" aria-labelledby="skipwaypointmodalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header pb-0" style="border-bottom: none;">
    ...
    <!-- picsignnotemodal -->
    <div class="modal fade" id="picsignnotemodal" tabindex="-1" role="dialog" aria-labelledby="picsignnotemodalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md " role="document">
            <div class="modal-content">
                <div class="modal-header pt-1 pb-2 pr-1" style="border-bottom: none;">
                    <button type="button" id="btn_complete_add" class="close d-none" data-dismiss="modal"
                        aria-label="Close">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect width="24" height="24" rx="12" fill="#E5E5E5" />
                ...
                <div class="modal-body   pt-0">
                    <form id="complete_waypoint" action="completeWaypoint" method="POST">
                        ...
                        <input type="hidden" name="required-fields" id="required-fields" data-trip-pic="0"
                            data-trip-signature="0" data-trip-note="0">
                        <div class="file-input" style="width: 100%;">
                            <label for="file" class="p-5 text-center"
                                style="border-radius: 10px; background-color: #F8F8F8; width: 100%; height:126px !important">
                        ...
                        <div style="width: 100%;">
                            <div class="row mb-2">
                                <div class="col-lg-12" id="signature-div">
                                    <button type="button" id="signature-btn" class="btn text-center p-2"
                                        style="border-radius: 10px; background-color: #F8F8F8; width: 100%; height:55px !important">
                                        <p class="mt-3 mb-0" style="color: #D9D9D9;">@lang('lang.signature')</p>
                                    </button>
                                </div>
                                <div class="col-lg-2 p-0 my-2">
                                    <div class="">
                                        <button type="button" class="btn p-2 btn-secondary" style="display: none;"
                                            id="clear-btn">
                                            @lang('lang.clear')
                        ...
                        <div class="form-group">
                            ...
                            <p id="charCountContainer1" class="text-secondary text-right" style="display: none;"><span
                                    id="charCount1">150</span> /150</p>
                            <div class="d-none" id="error_message_note" style=" color: red;"> * @lang('lang.description_is_requried') </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-lg-6 "></div>
                            <div class="col-lg-6 ">
                                <button class="btn btn-sm  btn_statusUpdate text-white" id="picsignnot-btn"
                                    style="background-color: #233A85; border-radius: 8px; width: 100%;">
                                    <div class="spinner-border spinner-border-sm text-white d-none" id="spinner"></div>
